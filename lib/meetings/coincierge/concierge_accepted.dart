...
class ConciergeAcceptedMeetings extends StatefulWidget {
  @override
  _ConciergeAcceptedMeetingsState createState() =>
      _ConciergeAcceptedMeetingsState();
}
                  ...
                  return const Center(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "No accepted meetings at the moment",
                            textAlign: TextAlign.center,
