...
import 'eventSpeakersScreen.dart';
...
class FullAgendaScreen extends StatefulWidget {
  ...
  FullAgendaScreen(
      {super.key,
      required this.title,required this.eventID,
      required this.day,
      required this.date,
...
class _FullAgendaScreenState extends State<FullAgendaScreen> {
  ...
  void initState() {
    ...
    if (widget.breakOuts != null)
      print("breakouts are ${widget.breakOuts.length}");
            ...
            children: [
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: kCISOPurple),
                  child: Text(
                    replaceUnderscoresWithSpaces(widget.type.toUpperCase()),
                    style: const TextStyle(
                        fontSize: 12, color: kGradientLighterBlue),
                  )),
                ...
                children: [
                  Column(
                    children: [
                      Text(
                        widget.date,
                        style: kFullAgendaDayTextStyle(fontsiZe: 15),
                      ),
                      Text(
                        widget.day.toString(),
                        style: kFullAgendaDateTextStyle(fontsiZe: 30),
                      ),
                    ],
                  ),
                  ...
                  Flexible(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${convertToAmPm(widget.startTime)} - ${convertToAmPm(widget.endTime)} ",
                        ...
                        if (widget.speakers != false)
                          FutureBuilder<List<IndividualSpeaker?>>(
                        ...
                        //     scrollDirection:Axis.horizontal,itemCount: widget.speakers.length,itemBuilder: (BuildContext context, int index){
              ...
              if (widget.description != null || widget.description != "")
                Text(
                  widget.description,
                  style: const TextStyle(fontSize: 16, color: kTextColorGrey),
                ),
              const Divider(),
              verticalSpace(height: 10),
              if (widget.breakOuts != null)
              ...
              if (widget.breakOuts != null)
                BreakOutWidget(
                  breakOutSessions: widget.breakOuts,
                ),
