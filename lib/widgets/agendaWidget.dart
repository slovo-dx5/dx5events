        ...
        PersistentNavBarNavigator.pushNewScreen(
          ...
          screen: FullAgendaScreen(
             ...
             userID: userID,
              description: summary,
              speakers: speakers,
              breakOuts: breakoutSessions, eventLocation: eventLocation, eventDay: eventDay, eventMonth: eventMonth, eventYear: eventYear, futures: futures, date: eventDayOfWeek,
          ),
          withNavBar: false,
      ...
      GestureDetector( onTap:(){
        PersistentNavBarNavigator.pushNewScreen(
          ...
          screen: FullAgendaScreen(eventLocation: eventLocation, eventDay: eventDay, eventMonth: eventMonth, eventYear: eventYear,
              ...
              speakers: false,
              breakOuts: breakoutSessions, futures: null, date: eventDayOfWeek,
          ),
          withNavBar: false,
          pageTransitionAnimation: PageTransitionAnimation.slideRight,
        );
